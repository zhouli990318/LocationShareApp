    ...
    public class BatteryChartDrawable : IDrawable
    {
        ...
        private void DrawLabels(ICanvas canvas, RectF chartRect)
        {
            ...
            for (int i = 0; i <= 4; i++)
            {
                ...
                canvas.DrawString(percentage, chartRect.Left - 15, y, HorizontalAlignment.Right, VerticalAlignment.Center);
            }
            ...
            if (BatteryData != null && BatteryData.Any())
            {
                ...
                for (int i = 0; i <= 6; i++)
                {
                    ...
                    canvas.DrawString(timeLabel, x, chartRect.Bottom + 15, HorizontalAlignment.Center, VerticalAlignment.Top);
                }
            }
        }
    }
