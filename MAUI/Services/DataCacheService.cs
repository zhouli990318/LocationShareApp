...
namespace LocationShareApp.Services
{
    public class DataCacheService : IDataCacheService
    {
        ...
        public DataCacheService(IStorageService storageService, IApiService apiService, ISignalRService signalRService, ILogger<DataCacheService> logger)
        {
        ...
        public async Task<List<LocationCacheItem>> GetCachedLocationDataAsync()
        {
            ...
            {
                _logger.LogError(ex, "获取缓存位置数据失败");
            }
        ...
        public async Task<List<BatteryCacheItem>> GetCachedBatteryDataAsync()
        {
            ...
            {
                _logger.LogError(ex, "获取缓存电量数据失败");
            }
