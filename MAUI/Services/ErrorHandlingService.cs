...
namespace LocationShareApp.Services
{
    public class ErrorHandlingService : IErrorHandlingService
    {
        ...
        public ErrorHandlingService(IStorageService storageService, ILogger<ErrorHandlingService> logger)
        {
        ...
        public async Task HandleUnhandledExceptionAsync(Exception exception)
        {
            ...
            {
                _logger.LogError(logException, "记录未处理异常失败");
            }
        }
